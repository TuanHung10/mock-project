$(function () {
    ...
    $(".sidebar").load("./common/sidebar.html", function () {
        document.getElementById("sidebar-lastname").innerHTML = 'Hello ' + storage.getItem("FIRST_NAME") + "!";
    });
    $(".main").load("./home/homePage.html", function () {
        document.getElementById("line-2").innerHTML = 'Hello ' + storage.getItem("FIRST_NAME") + "!";
    });
