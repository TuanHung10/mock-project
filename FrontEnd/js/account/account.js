...
function resetFormUpdateAccount() {
    ...
    //display data of this account can be block
    // document.getElementById("modal-role-select").style.display = "block";
...
function showUpdateAccountModal(id) {
    $.ajax({
        ...
        success: function (data, textStatus, xhr) {
            ...
            oldrole = data.role;
            olddepartmentName = data.departmentName;
            ...
            document.getElementById("modal-department-select").value = data.departmentName;
        },
        error(jqXHR, textStatus, errorThrown) {
            console.log(jqXHR);
            console.log(textStatus);
